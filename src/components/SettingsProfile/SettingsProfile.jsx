  ...
  return (
    ...
    >
      <div className={styles.inputWrapper}>
        <h2>Full Name</h2>
        <input type="text" placeholder={oldName} onChange={(e) => handleNameChange(e.target.value)}/>
        <input type="text" placeholder={oldSurname} onChange={(e) => handleSurnameChange(e.target.value)}/>
      </div>
      <div className={styles.divider}></div>
      <div className={styles.inputWrapper}>
        <h2>Email</h2>
        <input type="email" placeholder={oldEmail} onChange={(e) => handleEmailChange(e.target.value)}/>
      </div>
      <div className={styles.divider}></div>
